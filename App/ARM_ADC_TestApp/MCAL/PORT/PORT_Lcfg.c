...
const Port_ConfigType STR_PortsConfig[PORT_PINS_NUM] = {
    ...
    {PORT_PIN_DEN, PORT_PIN_LOW, PORT_PIN_INPUT, PORT_PIN_PUR, PORT_PIN_CUR_8MA, PORT_A, PORT_PIN_2},
    {PORT_PIN_DEN, PORT_PIN_LOW, PORT_PIN_INPUT, PORT_PIN_PUR, PORT_PIN_CUR_8MA, PORT_A, PORT_PIN_3},
    {PORT_PIN_DEN, PORT_PIN_LOW, PORT_PIN_INPUT, PORT_PIN_PUR, PORT_PIN_CUR_8MA, PORT_A, PORT_PIN_4},
    ...
    {PORT_PIN_DEN, PORT_PIN_LOW, PORT_PIN_INPUT, PORT_PIN_PUR, PORT_PIN_CUR_8MA, PORT_C, PORT_PIN_4},
    {PORT_PIN_DEN, PORT_PIN_LOW, PORT_PIN_INPUT, PORT_PIN_PUR, PORT_PIN_CUR_8MA, PORT_C, PORT_PIN_5},
    {PORT_PIN_DEN, PORT_PIN_LOW, PORT_PIN_INPUT, PORT_PIN_PUR, PORT_PIN_CUR_8MA, PORT_C, PORT_PIN_6},
    {PORT_PIN_DEN, PORT_PIN_LOW, PORT_PIN_INPUT, PORT_PIN_PUR, PORT_PIN_CUR_8MA, PORT_C, PORT_PIN_7},
