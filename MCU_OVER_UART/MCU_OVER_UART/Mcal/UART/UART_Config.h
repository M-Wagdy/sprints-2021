...
#define UART_CH_0_CONTROL                 (ENABLE_RX | ENABLE_TX)
#define UART_CH_0_CONTROL_2               (SET_PARITY_STOP_AND_DATA_SIZE | NO_PARITY | STOP_1_BIT | DATA_8_BITS)
#define UART_CH_0_BaudRate                CLK_8_MHZ_9600_BAUD
