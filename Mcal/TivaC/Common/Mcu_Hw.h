...
/*- ADC Registers--------------------------------------*/
/*- ADC Base Addresses---------------------------------*/
#define ADC0_BASE_ADDRESS               (uint32_t)(0x40038000)
#define ADC1_BASE_ADDRESS               (uint32_t)(0x40039000)

/*- GPT Registers offsets------------------------------*/
#define ADC_ACTIVE_OFFSET               (uint32_t)(0x000)
#define ADC_IM_OFFSET                   (uint32_t)(0x008)
#define ADC_ISC_OFFSET                  (uint32_t)(0x00C)
#define ADC_MUX_OFFSET                  (uint32_t)(0x014)
#define ADC_SS_PRI_OFFSET               (uint32_t)(0x020)
#define ADC_PSSI_OFFSET                 (uint32_t)(0x028)
#define ADC_SS0_MUX_OFFSET              (uint32_t)(0x040)
#define ADC_SS0_CTL_OFFSET              (uint32_t)(0x044)
#define ADC_SS0_FIFO_OFFSET             (uint32_t)(0x048)
#define ADC_SS1_MUX_OFFSET              (uint32_t)(0x060)
#define ADC_SS1_CTL_OFFSET              (uint32_t)(0x064)
#define ADC_SS1_FIFO_OFFSET             (uint32_t)(0x068)
#define ADC_SS2_MUX_OFFSET              (uint32_t)(0x080)
#define ADC_SS2_CTL_OFFSET              (uint32_t)(0x084)
#define ADC_SS2_FIFO_OFFSET             (uint32_t)(0x088)
#define ADC_SS3_MUX_OFFSET              (uint32_t)(0x0A0)
#define ADC_SS3_CTL_OFFSET              (uint32_t)(0x0A4)
#define ADC_SS3_FIFO_OFFSET             (uint32_t)(0x0A8)
